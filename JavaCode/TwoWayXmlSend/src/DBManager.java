...
public class DBManager {
	...
	//public static void main(String[] args) {
		...
		//System.out.println("Updated user " + addeduser + "with new ip: " + con.returnIPfromID(addeduser));
	...
	public int addNewUser(String ip) {
		...
		Statement stmt = null;
		try{
			//if user does not already exist with that ip address create a new user
			if(!(userIPExists(ip))) {
		stmt = connection.createStatement();
