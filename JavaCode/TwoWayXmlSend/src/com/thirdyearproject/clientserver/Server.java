	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			if (!(fparray[0].equals("xxx.xml"))) {
				...
				sendrecsock.SendViaSocket(pathwaystart+"encryptedtosend.key");
				sendrecsock.ReceiveViaSocket(pathwaystart.concat("servack.txt"));
				...
				if (rec == 'y') {
					...
					con.updateUser(currentID, "messloc3",pathwaystart.concat("messloc3for"+Integer.toString(receiveruserID)+".txt"));
					sendrecsock.SendViaSocket(pathwaystart+"encryptedtosend.key");
